...
namespace PersonalLibraryProject_comp229.Pages
{
    public partial class insertBook : System.Web.UI.Page
    {
        ...
        {
            insertBookInformation(titleTextField.Text, bookDetailsTextField.Text, isbnNoTextField.Text, false, DateTime.Now);
        }
        ...
        protected void insertBookInformation(string bookTitle, string bookDetail, string isbnNo, bool isAvailable, DateTime date)
        {
            ...
            SqlCommand comm = new SqlCommand("INSERT INTO Books(isbn_no, book_name, book_detail, is_available, date) VALUES(@isbn_no,@book_name, @book_detail, @isAvilable, @date))", connection);
